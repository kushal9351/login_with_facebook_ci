        ...
        <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav ms-auto d-flex flex-row">
                    ...
                    <li class="nav-item dropdown">
                        <a href="" class="nav-link btn dropdown-toggle hidden-arrow d-flex align-items-center" id="navbarDropdownMenuLink" data-bs-toggle="dropdown" role="button" aria-expanded="false">
                            <!-- <a class="nav-link dropdown-toggle hidden-arrow d-flex align-items-center" href="#" id="navbarDropdownMenuLink" role="button" data-mdb-toggle="dropdown" aria-expanded="false"> -->
                            <img src="https://mdbootstrap.com/img/Photos/Avatars/img (31).jpg" class="rounded-circle" height="22" alt="" loading="lazy" />
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a style="cursor: pointer" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#profile"> <img src="/image/person-circle.svg" alt="" class="mx-2 my-2"> Edit profile</a></li>
                            <!-- <li><a style="cursor: pointer"  class="dropdown-item" data-bs-toggle="modal" data-bs-target="#profile">Edit profile</a></li> -->
                            <li><a class="dropdown-item" href="#"> <img src="/image/gear-wide.svg" alt="" class="mx-2 my-2"> Settings</a></li>
                            <li><a class="dropdown-item" href="#"> <i class="fa-solid fa-bookmark mx-2 my-2"></i> Saved</a></li>
                            <li><a class="dropdown-item" href="#"> <i class="fa-solid fa-repeat mx-2 my-2"></i> Switch</a></li>

                            <!-- <li><a class="dropdown-item" href="#">Something else here</a></li> -->
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="<?php echo base_url('/login/logout') ?>"><i class="fa-solid fa-right-from-bracket mx-2 my-2"></i> Logout</a></li>
                        </ul>
                    </li>
