...
<div class="container col-md-2 my-5">
    <div class="upContainer text-center px-3 border border-secondary">
        <h1 class="my-5; font-family: 'Pacifico', cursive;" style="margin-top: revert;">Instagram</h1>
            ...
            <!-- ************************************************************************************** -->
                <div class="field">
                    <div class="control">
                        <input type="text" class="input-text" name="mobileNumberEmailAddress" placeholder=" ">
                ...
                <button class="btn btn-primary my-3" style="width: 100%;" type="submit">Sign Up</button>
            </form>


                <div class="md-2">---------- OR ----------</div>
                <a class=" px-4 my-2" type="button" style="width: 100%; text-decoration: none; color: #385185;" href="#"><img src="https://cdn-icons-png.flaticon.com/512/124/124010.png" alt="" style="height:15px; margin-bottom: 3px; margin-right: 9px;">Login with Facebook</a>
            <!-- <hr style="width: 20vw;"> -->


            <a href="" class="md-2" style="color: #385185; text-decoration: none; font-size: 12px;">Forgot password?</a>
                
            <!-- <div class="phoneNOEmailField">
                <input type="text">
            </div> -->
    </div>
    <div class="downContainer text-center my-3 p-3 border border-secondary">
        Don't have an account? <a href="<?= base_url('user/login') ?>">Sign up</a>
    </div>
